...
public interface SQLCommands {
    ...
    String SQL_INSERT_INTO_EMPLOYEE = "INSERT INTO Employee (id_department, date_of_birth, name_of_employee, date_of_employment, position_of_employee) VALUES " +
            "(2, '08.09.69', 'Jael F. Ballard','09.19.20', 'FrontendDev'), (1, '15.09.98', 'Maxwell J. Brady','03.28.21', 'BackendDev'), (1, '05.07.96', 'Gregory Ratliff','04.06.22', 'BackendDev'), (1, '15.12.87','Rina O. Madden','08.05.22', 'DevOps'), (2, '12.08.78', 'Philip C. Cline','09.02.21', 'QA'), (3, '09.08.88', 'Uta Rose','04.01.22', 'Team-Lead'), (2, '30.02.89', 'Derek C. Sanders','04.12.21', 'Fullstack'), (3, '17.04.87', 'Samantha L. Wood','10.06.21', 'Team-Lead'), (3,'01.08.98', 'Leandra Hayden','08.24.21', 'BackendDev'), (3,'18.11.78', 'Daniel F. Travis','03.01.21', 'Fullstack'), (1, '08.09.86', 'Kate U. Winson', '08.09.89', 'Secretary'), (2, '31.09.86', 'David U. Nilson', '08.09.86', 'Admin')";
    ...
    String SQL_SELECT_ALL_EMPLOYEES = "SELECT * FROM Employee";
    String SQL_SELECT_ALL_EMPLOYEES_SURNAME_ASC = "SELECT name_of_employee FROM employee ORDER BY name_of_employee ASC;";
    String SQL_SELECT_ALL_EMPLOYEES_DATE_OF_EMPLOYMENT_ASC = "SELECT name_of_employment, date_of_employment FROM Employee ORDER BY date_of_employment_ASC";
